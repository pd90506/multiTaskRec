...
def loadMLData(file_dir, train_dir, test_dir):
    """
    Args:
    ...
    ml_rating = pd.read_csv(file_dir, header=None, sep='\t',names=['uid', 'mid', 'rating', 'timestamp'])
...
if __name__ == "__main__":
    ...
    loadMLData(file_dir, train_dir, test_dir)
