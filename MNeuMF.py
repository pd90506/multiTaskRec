...
from tensorflow.keras.layers import Embedding, Input, Dense, Multiply, Reshape, Flatten, Concatenate,  Dot
...
def get_model(num_users, num_items, num_tasks, mf_dim=10, layers=[10], reg_layers=[0], reg_mf=0):
